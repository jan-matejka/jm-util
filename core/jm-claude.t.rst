...
worktree with compose.yaml::
  ...
  $ jm claude
  /tmp/dramtests-(.*)/home/user/src/core/jm-claude.t.rst/tmp/bin/podman run -it --rm --name jm_claude_foo_wip --userns=keep-id:uid=1000,gid=1000 --cap-drop=ALL --security-opt=no-new-privileges --read-only -v ./:/src/wip -v ../master:/src/master:ro -v /.*/.config/jm-util/claude/conf:/home/user/.config/claude -v /.*/.local/share/jm-util/claude/p/foo/wip:/home/user/.local/share/claude -v /.*/primary/settings.json:/home/user/.local/share/claude/settings.json -v /.*/primary/.credentials.json:/home/user/.local/share/claude/.credentials.json ghcr.io/jan-matejka/claude:latest (re)
...
chmod::
  ...
  750 drwxr-x---
  $ stat -c '%a %A' $HOME/.local/share/jm-util/claude/p/foo/wip
  750 drwxr-x---
...
primary::
  ...
  $ jm claude -p
  .* -v /tmp/.*/home/.local/share/jm-util/claude/primary:/home/user/.local/share/claude .* (re)
